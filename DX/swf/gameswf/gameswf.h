...
namespace gameswf
{
	...
	void  reset_render_handler_d3d(IDirect3DDevice9* device,gameswf::render_handler* rend_hndlr);
	void  release_render_handler_d3d(gameswf::render_handler* rend_hndlr);
#ifdef TU_USE_SDL
