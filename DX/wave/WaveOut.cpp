...
void CALLBACK waveOutProc(HWAVEOUT hwo, UINT uMsg, DWORD dwInstance, DWORD dwParam1, DWORD dwParam2)
{
	...
	switch(uMsg) {
	case MM_WOM_DONE:
		WAVEHDR* pWaveHdr = reinterpret_cast<WAVEHDR*>((DWORD_PTR)dwParam1 );
		CWaveOut* pWaveOut = reinterpret_cast<CWaveOut*>(pWaveHdr->dwUser);
...
CWaveOut::CWaveOut(const CWave& aWave, const CWaveDevice& aDevice) : m_wave(aWave), m_waveDevice(aDevice), \
	m_hWaveOut(0), m_nIndexWaveHdr(-1), m_dwStartPos(0L), m_dwWaveOutBufferLength(WAVEOUT_BUFFER_SIZE)
{
}

//////////////////////////////////////////////////////////////////////
CWaveOut::CWaveOut() : m_hWaveOut(0), \
	m_dwStartPos(0L),m_nIndexWaveHdr(-1), m_dwWaveOutBufferLength(WAVEOUT_BUFFER_SIZE)
{
}
...
bool CWaveOut::Open()
{
	return !IsError( waveOutOpen(&m_hWaveOut, m_waveDevice.GetDevice(), &m_wave.GetFormat(), (DWORD_PTR)waveOutProc, NULL, CALLBACK_FUNCTION) );
}
...
//////////////////////////////////////////////////////////////////////
std::string CWaveOut::GetError() const
{
