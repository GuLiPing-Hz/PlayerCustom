...
DataLogImpl::CritSectScopedPtr DataLogImpl::crit_sect_(CriticalSectionWrapper::CreateCriticalSection());
...
class LogTable 
{
 public:
  ...
  int CreateLogFile(const std::string& file_name,bool utf8=true);
...
int LogTable::CreateLogFile(const std::string& file_name,bool utf8) {
